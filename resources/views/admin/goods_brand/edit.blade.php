  ...
  <form method="post" action="" role="form" enctype="multipart/form-data" class="layui-form">{{ csrf_field() }}
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
          ...
          <input type="radio" value="1" name="status" <?php if ($post->status == 1) { echo 'checked'; } ?> title="否" />
        </div>
    </div>
    <div class="layui-form-item">
      <label class="layui-form-label">排序</label>
      <div class="layui-input-inline">
        <input name="listorder" type="text" id="listorder" value="<?php echo $post->listorder; ?>" class="layui-input">
      </div>
    </div>
    <div class="layui-form-item">
      <label class="layui-form-label">
...
<script type="text/plain" id="ueditorimg"></script>
    <div class="layui-form-item">
      ...
      <div class="layui-input-inline" style="width:400px;">
        <input name="cover_img" type="text" id="cover_img" value="<?php echo $post->cover_img; ?>" class="layui-input">
      </div>
      <div class="layui-input-inline">
        <input type="button" class="layui-btn" onclick="upImage2();" value="选择图片">
      </div>
      <div class="layui-input-inline">
        <img style="margin-left:20px;<?php if(empty($post->cover_img) || !is_image_format($post->cover_img)){ echo "display:none;"; } ?>" src="<?php if(is_image_format($post->cover_img)){echo $post->cover_img;} ?>" width="120" height="80" id="picview" name="picview">
      </div>
    </div>
<script type="text/javascript">
var _editor2;
...
<script type="text/plain" id="ueditorimg2"></script>
    <div class="layui-form-item">
      ...
      <div class="layui-input-block">
        <input id="seotitle" name="seotitle" value="<?php echo $post->seotitle; ?>" class="layui-input">
      </div>
    </div>
    <div class="layui-form-item">
