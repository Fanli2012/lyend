  ...
  <form method="post" action="" role="form" enctype="multipart/form-data" class="layui-form">{{ csrf_field() }}
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
          <input type="radio" value="0" name="status" title="正常" />
          <input type="radio" value="1" name="status" checked title="隐藏" />
        </div>
    </div>
    <div class="layui-form-item">
      <label class="layui-form-label">
    ...
    <div class="layui-form-item">
      ...
      <div class="layui-input-inline">
        <input id="title" name="title" value="" lay-verify="" placeholder="" class="layui-input">
      </div>
    </div>
    <div class="layui-form-item">
      <label class="layui-form-label">
      ...
      <div class="layui-input-inline">
        <input id="template" name="template" value="tag" lay-verify="" placeholder="" class="layui-input">
      </div>
    </div>
    <div class="layui-form-item">
      <label class="layui-form-label">
...
<script type="text/plain" id="ueditorimg"></script>
    ...
    <div class="layui-form-item">
      ...
      <div class="layui-input-inline" style="width:50%;">
        <textarea name="tagarc" rows="3" id="tagarc" class="layui-textarea"></textarea>
      </div>
      <div class="layui-form-mid layui-word-aux">(多个用","分开)</div>
    </div>
    <div class="layui-form-item">
