...
<div class="admin-content-box-nav">
  <span class="layui-breadcrumb" lay-filter="breadcrumb" style="visibility:visible;">
    <a href="<?php echo route('admin_article_type'); ?>">文章栏目管理</a><span lay-separator="">/</span>
    <a href=""><cite>文章栏目修改</cite></a>
  </span>
</div>
  ...
  <form method="post" action="" role="form" enctype="multipart/form-data" class="layui-form">{{ csrf_field() }}
    ...
    <div class="layui-form-item">
      ...
      <div class="layui-input-block" style="width:300px;">
        <input id="name" name="name" value="<?php echo $post->name; ?>" lay-verify="required" placeholder="" class="layui-input">
      </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">栏目属性</label>
        <div class="layui-input-inline">
		<select name="is_part" id="is_part" lay-filter="">
            <option <?php if ($post->is_part == 0) { echo 'selected="selected"'; } ?> value="0">列表栏目（允许发布文档）</option>
            <option <?php if ($post->is_part == 1) { echo 'selected="selected"'; } ?> value="1">频道封面（不允许发布文档）</option>
        </select>
        </div>
    </div>
    <div class="layui-form-item">
      ...
      <div class="layui-input-inline">
        <input id="filename" name="filename" value="<?php echo $post->filename; ?>" lay-verify="required" placeholder="" class="layui-input">
      </div>
    ...
    <div class="layui-form-item">
      ...
      <div class="layui-input-inline">
        <input id="templist" name="templist" value="<?php echo $post->templist; ?>" lay-verify="required" placeholder="" class="layui-input">
      </div>
    </div>
    <div class="layui-form-item">
      <label class="layui-form-label">
        <font color="red">*</font>文章模板
      </label>
      <div class="layui-input-inline">
        <input id="temparticle" name="temparticle" value="<?php echo $post->temparticle; ?>" lay-verify="required" placeholder="" class="layui-input">
      </div>
    </div>
    <div class="layui-form-item">
...
<script type="text/plain" id="ueditorimg"></script>
    <div class="layui-form-item">
      ...
      <div class="layui-input-block">
        <input id="seotitle" name="seotitle" value="<?php echo $post->seotitle; ?>" lay-verify="" placeholder="" class="layui-input">
      </div>
    </div>
    <div class="layui-form-item">
      <label class="layui-form-label">
      ...
      <div class="layui-input-inline">
        <input id="keywords" name="keywords" value="<?php echo $post->keywords; ?>" lay-verify="" placeholder="" class="layui-input">
      </div>
