...
<div class="layui-fluid" style="padding:15px;">
  <form method="post" action="" role="form" enctype="multipart/form-data" class="layui-form">{{ csrf_field() }}
    ...
    <div class="layui-form-item">
      ...
      <div class="layui-form-mid layui-word-aux"><?php if ($parent_id == 0) { echo "顶级栏目"; } else { echo $parent_article_type->name; } ?></div>
    ...
    <div class="layui-form-item">
		...
		<select name="is_part" id="is_part" lay-filter="">
            <option selected="selected" value="0">列表栏目（允许发布文档）</option>
            <option value="1">频道封面（不允许发布文档）</option>
        </select>
        </div>
    </div>
    <div class="layui-form-item">
