...
class SlideModel extends BaseModel
{
     ...
     * @return string
     */
    public function getTargetTextAttr($data)
    {
        return self::$slide_target[$data->target];
    }

    //获取显示平台文字,0pc，1weixin，2app，3wap，4miniprogram
    public function getGroupIdTextAttr($data)
    {
        $arr = array(0 => 'pc', 1 => 'weixin', 2 => 'app', 3 => 'wap', 4 => 'miniprogram');
        return $arr[$data->group_id];
    }
