...
class WeixinMenuController extends BaseController
{
    ...
    public function add()
    {
        if (!empty($_GET["reid"])) {
            ...
            if ($id != 0) {
                $data['postone'] = object_to_array(DB::table("weixin_menu")->where('id', $id)->first());
            }
    ...
    public function edit()
    {
        ...
        $data['id'] = $id;
        $post = object_to_array(DB::table('weixin_menu')->where('id', $id)->first());
        $reid = $post['pid'];
        if ($reid != 0) {
            $data['postone'] = object_to_array(DB::table('weixin_menu')->where('id', $reid)->first());
        }
