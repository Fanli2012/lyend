...
class AdminRoleLogic extends BaseLogic
{
    ...
    {
        $res = $this->getModel()->append('status_text')->getList($where, $order, $field, $offset, $limit);
    ...
    {
        $res = $this->getModel()->append('status_text')->getPaginate($where, $order, $field, $limit);
    ...
    {
        $res = $this->getModel()->append('status_text')->getAll($where, $order, $field, $limit);
    ...
    {
        $res = $this->getModel()->append('status_text')->getOne($where, $field);
        if (!$res) {
            return false;
        }
