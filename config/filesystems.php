    ...
    */
    ...
    'disks' => [
        ...
        'oss' => [
            ...
            'endpoint' => env('OSS_ENDPOINT'), //OSS 外网节点或自定义外部域名, the endpoint of OSS, E.g: oss-cn-hangzhou.aliyuncs.com | custom domain, E.g:img.abc.com
            //'endpoint_internal' => env('OSS_ENDPOINT_INTERNAL'), //internal endpoint [OSS内网节点] 如：oss-cn-shenzhen-internal.aliyuncs.com, v2.0.4 新增配置属性，如果为空，则默认使用 endpoint 配置(由于内网上传有点小问题未解决，请大家暂时不要使用内网节点上传，正在与阿里技术沟通中
            ...
            'debug' => env('OSS_DEBUG', true), // true|false
        ],
